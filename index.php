...
<h1 style="color:white; margin-top: 25px;"><b>Please rotate the device. </b><br>We support only landscape mode.</h1>
</div>
...
<div id="container">
    ...
    <style>
        ...
        .mybtn {
            margin-bottom: 10px;
            box-shadow: 2px 2px 10px #2986cc;
            border-radius: 30px;
    ...
    <nav class="navbar navbar-expand-lg navbar-blue bg-light fixed fixed-top"
        style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px #2986cc;">
        <div class="container-fluid">
            <a href="index.php"><img src="images/Sparks Bank Logo.png" alt=""
    ...
    <div class="container-large"
        style="color:#2986cc; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:white;">
        <div class="row">
    ...
    <img src="images/image3.jpg" alt="" style="width:100%; position:absolute; z-index:-1">
        ...
        <div class="container"
            ...
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#2986cc; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
