...
<body style="background-color:#ffffff;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:#2986cc; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px white;">
                <h1 style=" color:white;">About Us</h1>
            </div>
            <br><br>
            <img src="images/Sahil Image.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px gray;">
            <br><br>
            <p style="color:grey;">This website is created by</p>
            <h1 style="color:gray; text-shadow:2px 2px 2px gray;">Sahil Suvarna</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Lokmanya Tilak College of Engineering, Mumbai</b></p>
    </center>
